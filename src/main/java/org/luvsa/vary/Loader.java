...
public interface Loader {
    ...
    default <R extends TypeSupplier> void load(Class<R> clazz, BiConsumer<Class<?>, R> consumer) {
     ...
     */
    <R extends TypeSupplier> void load(Class<R> clazz, BiConsumer<Class<?>, R> next, Consumer<R> err);
